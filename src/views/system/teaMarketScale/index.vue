<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="线上市场规模" prop="teaMarketSize">
        <el-input
          v-model="queryParams.teaMarketSize"
          placeholder="请输入线上市场规模"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="增长率" prop="teaGrowthRate">
        <el-input
          v-model="queryParams.teaGrowthRate"
          placeholder="请输入增长率"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="teaMarketScaleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="增长率" align="center" prop="id" />
      <el-table-column label="线上市场规模" align="center" prop="teaMarketSize" />
      <el-table-column label="增长率" align="center" prop="teaGrowthRate" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="线上市场规模" prop="teaMarketSize">
          <el-input v-model="form.teaMarketSize" placeholder="请输入线上市场规模" />
        </el-form-item>
        <el-form-item label="增长率" prop="teaGrowthRate">
          <el-input v-model="form.teaGrowthRate" placeholder="请输入增长率" />
        </el-form-item>
      </el-form>
