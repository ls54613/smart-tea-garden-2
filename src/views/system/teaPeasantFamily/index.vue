  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="性别0=男 1=女 2=未知" prop="familySex">
        <el-select v-model="queryParams.familySex" placeholder="请选择性别0=男 1=女 2=未知" clearable size="small">
      ...
      <el-form-item label="证件类型1=身份证 " prop="cardType">
        <el-select v-model="queryParams.cardType" placeholder="请选择证件类型1=身份证 " clearable size="small">
          <el-option label="请选择字典生成" value="" />
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="关联茶农id" prop="teaPeasantId">
        <el-input
          v-model="queryParams.teaPeasantId"
          placeholder="请输入关联茶农id"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="teaPeasantFamilyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="性别0=男 1=女 2=未知" align="center" prop="familySex" />
      <el-table-column label="关系" align="center" prop="relationship" />
      <el-table-column label="证件类型1=身份证 " align="center" prop="cardType" />
      <el-table-column label="证件号" align="center" prop="idCard" />
      <el-table-column label="关联茶农id" align="center" prop="teaPeasantId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="证件类型1=身份证 " prop="cardType">
          <el-select v-model="form.cardType" placeholder="请选择证件类型1=身份证 ">
            <el-option label="请选择字典生成" value="" />
          </el-select>
        </el-form-item>
        <el-form-item label="证件号" prop="idCard">
        ...
        <el-form-item label="关联茶农id" prop="teaPeasantId">
          <el-input v-model="form.teaPeasantId" placeholder="请输入关联茶农id" />
        </el-form-item>
      </el-form>
